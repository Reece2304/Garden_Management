...
<body>
	...
	<nav>
		...
		<label class="welcome"> <span class="username">${User.username}</span>'s Logs</label>
	</nav>
	...
	<tr>
	<td> <img src="${Plant.imageURL}" style="height:200px; width:200px;"/> </td>
	<td style="font-weight:550; font-size:24px;"> ${Plant.name} </td>
	<td style="font-weight:550; font-size:24px;"> ${Plant.border } </td>
	<td style="font-weight:550; font-size:24px;"><i class="fas fa-tint fa-lg" id="water"></i>  ${Plant.wateringFrequency} </td>
	<td> <a class="link" href="/u/log/${User.role }/${Plant.id}">See logs </a></td>
	</tr>
	</c:forEach>
</table>
