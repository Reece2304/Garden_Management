	...
	<div class="container_login">
		<div class="container2_login">
				<div class="checkout">
					...
					<label style="color:Green; font-weight:500; text-align:center; font-size:25px;">Payment Successful </label>
					<label style="text-align:center; font-size:22px;">your account has been upgraded and you have been emailed!</label>
					<label class="basketbottom" style="text-align: center;"></label>
				</div>


				<div class="container_button">
					<a class="button" id="button" href="/u/home">Home </a>
				</div>
		</div>
	</div>
	<div class="footer">
